...
const sections = [
  ...
  },
  {
    id: 2,
    title: 'Layanan',
    intro: 'Layanan Sakuraku menyediakan sumber daya pembelajaran bahasa Jepang dan kelas daring, terutama untuk pengguna di Indonesia. Kami berhak untuk mengubah atau menghentikan Layanan kapan saja.',
    list: [],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    intro: 'Semua konten, merek dagang, dan materi di situs web kami (termasuk teks, gambar, dan video) adalah milik eksklusif Sakuraku atau pemberi lisensinya. Kamu tidak boleh menyalin, mereproduksi, atau mendistribusikan ulang materi kami tanpa persetujuan tertulis dari kami sebelumnya.',
    list: [],
  },
  {
    id: 7,
  ...
  },
  {
    id: 8,
    title: 'Pengakhiran',
    intro: 'Kami dapat mengakhiri atau menangguhkan akun kamu dengan segera, tanpa pemberitahuan sebelumnya, untuk alasan apa pun termasuk pelanggaran Ketentuan ini. Kamu juga dapat mengakhiri akun kamu kapan saja dengan menghubungi support@sakuraku.id.',
    list: [],
  },
  {
    id: 9,
    title: 'Hukum yang Mengatur dan Penyelesaian Sengketa',
    intro: 'Ketentuan ini akan diatur oleh hukum Republik Indonesia. Setiap sengketa yang timbul akan diselesaikan secara eksklusif di yurisdiksi Pengadilan Negeri Jakarta Selatan. Kedua belah pihak setuju untuk berusaha menyelesaikan sengketa melalui negosiasi atau mediasi secara damai terlebih dahulu.',
    list: [],
  },
];
  ...
  return (
    <main className="w-full bg-light-gray min-h-screen">
      <div className="w-full p-4 sm:p-8 lg:p-12 bg-white max-w-4xl mx-auto my-4 rounded-2xl text-[16px]">
        <h1 className="text-[32px] inter-bold mb-8">Syarat dan Ketentuan Layanan</h1>

        <p className="inter-regular text-dark-gray-text mb-8">
          Selamat datang di Sakuraku. Ketentuan Layanan ini mengatur akses dan penggunaan
          kamu atas situs web kami (https://sakuraku.id) dan layanan kami. Dengan membuat
          akun atau menggunakan Layanan kami, kamu setuju untuk terikat oleh Ketentuan ini.
        </p>
        ...
        <div className="w-full flex flex-col gap-8">
          {sections.map((section) => (
            <div key={section.id} className="w-full flex flex-col">
              ...
              {section.intro && (
                <p className="inter-regular mt-2 text-dark-gray-text">{section.intro}</p>
              )}
              {section.list.length > 0 && (
                <ul className="ml-6 mt-2">
                  {section.list.map((item, idx) => (
                    <li key={idx} className="list-disc inter-regular text-dark-gray-text mt-1">
                      {item}
                    </li>
                  ))}
                </ul>
