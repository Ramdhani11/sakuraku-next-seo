  ...
  return (
    <main className="w-full bg-light-gray min-h-screen">
      <div className="w-full p-4 sm:p-8 lg:p-12 bg-white max-w-4xl mx-auto my-4 rounded-2xl text-[16px]">
        ...
        <p className="mb-8 inter-bold text-gray-text">Terakhir Diperbarui: 30 Juli 2025</p>
        ...
        <div className="w-full flex flex-col gap-8">
          {sections.map((section) => (
            <div key={section.id} className="w-full flex flex-col">
              ...
              {section.desc && (
                <p className="inter-regular mt-2 text-dark-gray-text">{section.desc}</p>
              )}
        ...
        <p className="mt-8 inter-regular text-gray-text text-sm">
          Untuk informasi lebih lanjut tentang perusahaan kami, silakan kunjungi halaman{' '}
          <a href="/about-us" className="text-primary-color-sk underline">Tentang Kami</a>.
        </p>
      </div>
    </main>
  );
