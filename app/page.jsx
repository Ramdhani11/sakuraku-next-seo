  ...
  return (
    <main className="w-full max-w-[1920px] mx-auto p-2 mbl:p-6 overflow-x-hidden">
      ...
      <section className="flex justify-between flex-col mbl:flex-row mbl:items-center mbl:px-12 mt-12">
        ...
        <div className="w-full mbl:w-6/12 mt-8 mbl:mt-0">
          <p className="text-justify inter-regular text-[16px]">
            Di program ini, kamu akan belajar bahasa Jepang selangkah demi selangkah,
            mulai dari nol sampai jago. Latihan disusun biar kamu makin percaya diri
            sedikit demi sedikit, karena di tiap levelnya kamu akan dihadapi sama
            kalimat dan pola yang makin menantang.
          </p>
        </div>
      </section>
        ...
        <div className="flex flex-col mbl:flex-row w-full justify-start items-stretch gap-1">
          <div className="w-full mbl:w-[17.67%] flex flex-col gap-1">
            <div className="relative w-full h-[142px] rounded-lg overflow-hidden">
              <picture>
                <source srcSet="/img/landing/filler/fill-1-webp.webp" type="image/webp" />
                <img src="/img/landing/filler/fill-1-png.png" alt="" className="w-full h-full object-cover object-center" />
              </picture>
            </div>
            <div className="w-full h-[142px] bg-primary-indigo rounded-lg flex justify-center items-center text-[12px] text-white p-4">
              Belajar bahasa Jepang jadi lebih seru! Kumpulin EXP, naik level, dan lacak kemajuan kamu.
            </div>
          </div>
          <div className="w-full mbl:w-[27.95%] rounded-lg overflow-hidden">
            <picture>
              <source srcSet="/img/landing/filler/fill-3-webp.webp" type="image/webp" />
              <img src="/img/landing/filler/fill-3-png.png" alt="" className="w-full h-[285px] object-cover object-center" />
            </picture>
          </div>
          <div className="w-full mbl:w-[23.6%] flex flex-wrap gap-1">
            <div className="w-6/12 flex flex-col gap-1">
              <div className="w-full h-[142px] bg-light-orange-land rounded-full"></div>
              <div className="relative w-full h-[142px] rounded-lg overflow-hidden">
                <picture>
                  <source srcSet="/img/landing/filler/fill-5-webp.webp" type="image/webp" />
                  <img src="/img/landing/filler/fill-5-png.png" alt="" className="w-full h-full object-cover object-center" />
                </picture>
              </div>
            </div>
            <div className="w-6/12 flex flex-col gap-1">
          ...
          <div className="w-full mbl:w-[13.98%] rounded-lg overflow-hidden">
            <picture>
              <source srcSet="/img/landing/filler/fill-9-webp.webp" type="image/webp" />
              <img src="/img/landing/filler/fill-9-png.png" alt="" className="w-full h-[285px] object-cover object-top mbl:object-center" />
            </picture>
          </div>
        </div>
      </div>
      ...
      <section className="w-full mt-16">
        <h2 className="text-[36px] text-center poppins-black">Apa yang akan kamu dapatkan</h2>
        <p className="text-[16px] text-center inter-regular">
          Semua yang kamu butuhkan biar belajar bahasa Jepang makin lancar, dari latihan sampai pantau progres
        </p>
        <div className="w-full flex flex-col mbl:flex-row justify-between rounded-xl bg-primary-color-sk p-8 gap-4 mt-8">
          {features.map((f) => (
            <div key={f.title} className="w-full mbl:w-4/12 bg-white rounded-xl p-4">
              <img src={f.icon} alt={f.title} className="w-full max-h-[160px] object-contain" />
        ...
        <div className="w-full flex flex-col mbl:flex-row justify-between mb-8">
          ...
          <div className="w-full mbl:w-6/12 mt-4 md:mt-0">
            <p className="text-[16px] inter-regular">
              Ikuti alur belajar yang jelas dan terstruktur di setiap level perjalanan
              bahasa Jepang kamu. Mulai dari dasar hingga keahlian tingkat lanjut, setiap
              tahapan dirancang untuk menyambung dari materi sebelumnya.
            </p>
          </div>
        </div>
        <img src="/img/landing/steps.svg" alt="learning steps" className="hidden mbl:block w-full" />
        <img src="/img/landing/steps-m.png" alt="learning steps" className="block mbl:hidden w-full" />
      </section>
      ...
      <section className="w-full flex flex-col justify-between items-center rounded-xl bg-light-blue-landing p-8 gap-8 mt-8">
        <div className="w-full flex justify-start">
          <div className="w-full md:w-8/12 lg:w-6/12">
            <h2 className="text-[36px] poppins-black">Tes Terstruktur dari beginner sampai ekspert</h2>
          </div>
        </div>
        <div className="w-full flex flex-col md:flex-row justify-between px-0 md:px-8 gap-4">
          <div className="w-full md:w-6/12">
            <img src="/img/landing/test-terstruktur.svg" alt="structured test" className="block w-full" />
          </div>
          <div className="w-full md:w-6/12 flex items-center">
            <div className="w-full flex flex-col inter-regular items-start gap-2 text-[16px] text-justify">
              <p>
                Satu Jalur Belajar, Dari Dasar Hingga Mahir. Tak perlu bingung harus
                mulai dari mana. Mulai dari mengenal huruf Hiragana &amp; Katakana
                pelan-pelan, lanjut ke obrolan santai sehari-hari, sampai akhirnya
                masuk ke materi kompleks level mahir.
              </p>
              <p>
                Materinya disusun bertahap supaya kamu nggak kaget dan belajarnya tetap
                nyaman, tapi progresnya jelas terasa.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="w-full flex flex-col justify-between items-center rounded-xl bg-primary-soft-color-sk px-8 pt-8 gap-8 mt-8">
        <div className="w-full flex justify-center">
          <div className="w-full md:w-8/12 text-center">
            <h2 className="text-[36px] poppins-black">Artikel untuk latihan membaca</h2>
            <p className="mt-4 md:mt-8 inter-regular">
              Ingin coba membaca artikel dalam bahasa jepang? tapi takut mentok di satu
              kata kanji? Tenang alur baca tetap lancar, kamu cukup arahkan kursor ke
              kata yang kamu gatau, akan muncul tooltip kecil yang nunjukkin cara baca,
              dan terjemahan artinya!
            </p>
        ...
        <div className="w-[120%] sm:w-full flex justify-center">
          <img src="/img/landing/artikel.svg" alt="article feature" className="w-full" />
        </div>
      </section>
      ...
      <section className="w-full flex flex-col justify-center items-center bg-secondary-color-sk rounded-t-[50px] min-h-[400px] py-16 mt-8">
        <h2 className="poppins-bold text-[36px] text-center">Siap untuk mengambil</h2>
        <h2 className="poppins-bold text-[36px] text-center">langkah pertama?</h2>
        <div className="flex gap-2 items-center font-bold mt-8">
          <Link href="https://sakuraku.id/login"
